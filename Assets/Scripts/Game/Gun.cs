...
public class Gun : MonoBehaviour
{
    ...
    /// </summary>
    public bool shotgun = false;     //brane ako aktualny rezim
    ...
    public void ShootGun(Transform director)
    {
        ...
        if (shotgun == true)
        {
            SpawnBullet( 
                new Vector3 { x = director.position.x, y = director.position.y, z = 0.0f },
                Quaternion.Euler(director.eulerAngles.x, director.eulerAngles.y, director.eulerAngles.z + 10.0f)
            );
            SpawnBullet( 
                new Vector3 { x = director.position.x, y = director.position.y, z = 0.0f },
                Quaternion.Euler(director.eulerAngles.x, director.eulerAngles.y, director.eulerAngles.z - 10.0f)
    ...
    public void SpawnBullet(Transform director)
    {
        ...
        var bulletRotation = Quaternion.Euler(director.eulerAngles); //def Quaternion.Euler(director.eulerAngles), tried: rotation
    ...
    public void AdjustFireRate(float magnitude)
    {
        ...
        //fireRate = Math.Max(fireRate + magnitude * 10.0f, 1.0f);  //ZAKOMENTOVANE
        fireRate = Math.Max(magnitude, 1.0f);  //PRIDDANIE, pouzitie bez zmeny firerate vo vzorci
    }
